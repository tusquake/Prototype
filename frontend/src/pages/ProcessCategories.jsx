...
import ProcessCategoryCreateModal from '../components/ProcessCategoryCreateModal';
...
export default function ProcessCategories() {
  ...
  const [formErrors, setFormErrors] = useState({ code: '', name: '', description: '' });
  ...
  useEffect(() => {
    if (showCreateModal) {
      ...
      setName('');
      setDescription('');
      setFormErrors({ code: '', name: '', description: '' });
      setError(null);
    }
  }, [showCreateModal]);
  ...
  useEffect(() => {
    ...
    setFormErrors({
      code: fieldErrors.categoryCode?.[0] || '',
  ...
  async function handleCreate(e) {
    ...
    if (!parsed.success) {
      ...
      setFormErrors({
        code: fe.categoryCode?.[0] || '',
        name: fe.categoryName?.[0] || '',
  ...
  return (
    <>
            ...
            <table className="w-full border-collapse text-[11px] uppercase tracking-[0.6px] bg-bg-surface px-6 py-3">
              <thead>
                <tr className=" border-b border-[#e2e8f0]  text-left text-[11px] uppercase tracking-[0.5px]">
                  ...
                  <th className="px-4  py-3 text-right  text-[#94a3b8]"></th>
                </tr>
              </thead>
              <tbody>
                {loading ? (
            ...
            <div className="flex max-h-[70vh] flex-col gap-5 overflow-y-auto px-7 py-6">
              ...
              <form onSubmit={handleCreate} noValidate className="flex flex-col gap-4">
                <div className="flex flex-col gap-1">
                  ...
                  />
                  {formErrors.code && <p className="text-red-500 text-[12px] mt-1">{formErrors.code}</p>}
                </div>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  />
                  {formErrors.description && <p className="text-red-500 text-[12px] mt-1">{formErrors.description}</p>}
                </div>
      ...
      {showCreateModal && <ProcessCategoryCreateModal
      onSuccess={()=>{
        fetchCategories();
        setSuccessMsg( 'Process Category created successfully.');
        setShowCreateModal(false)
      ...
      {editingCategory && <ProcessCategoryDetailModal
      ...
      {deleteCategoryTarget && <ConfirmationModal
