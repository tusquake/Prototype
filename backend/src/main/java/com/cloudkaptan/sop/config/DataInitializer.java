...
//                     User.builder().userId("usr-manoj-042").email("manoj.agarwal@cloudkaptan.com")
//                             .fullName("Manoj Agarwal").role(UserRole.ADMIN).entity(us).isActive(true).build(),
//                     User.builder().userId("usr-vivek-108").email("vivek.raj@cloudkaptan.com").fullName("Vivek Raj")
//                             .role(UserRole.VIEWER).entity(india).isActive(true).build(),
//                     User.builder().userId("usr-mainak-215").email("mainak.gupta@cloudkaptan.com")
//                             .fullName("Mainak Gupta").role(UserRole.VIEWER).entity(india).isActive(true).build(),
//                     User.builder().userId("usr-tushar-304").email("tushar.seth@cloudkaptan.com").fullName("Tushar Seth")
//                             .role(UserRole.VIEWER).entity(uk).isActive(true).build(),
//                     User.builder().userId("usr-prayasa-410").email("prayasa.sharma@cloudkaptan.com")
//                             .fullName("Prayasa Sharma").role(UserRole.VIEWER).entity(india).isActive(true).build(),
//                     User.builder().userId("usr-avisek-499").email("avisek.old@cloudkaptan.com").fullName("Avisek Old")
//                             .role(UserRole.VIEWER).entity(india).isActive(true).build()));
//         }
...
//         log.info(
//                 "[DataInitializer] Resetting and Seeding User Hierarchy with horizontal Level 2 manager permissions...");
//         userHierarchyRepository.deleteAll();

//         List<UserHierarchy> hierarchy = List.of(
//                 // Level 1 Lead -> Level 2 Managers & Level 3 Team Members: Anirban manages
//                 // everyone with Read & Write access
...
//                 // Level 2 Manager (Annu Shaw) -> Level 3 Team Members (Ayush & Debajyoti) -
//                 // Read-Only
//                 UserHierarchy.builder()
...
//                 // Level 2 Manager (Avisek Shaw) -> Level 3 Team Members (Ayush & Debajyoti) -
//                 // Read-Only (Horizontal Hierarchy)
//                 UserHierarchy.builder()
...
//         log.info(
//                 "[DataInitializer] Seeded 8 organizational hierarchy relationships with horizontal Level 2 manager permissions.");
//     }
// }